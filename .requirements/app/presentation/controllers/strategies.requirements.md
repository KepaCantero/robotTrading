# Requirements: presentation/controllers/strategies.py

**Module**: strategies
**Layer**: 8 - Presentation Controllers/Views
**Line Count**: 453
**Generated**: 2026-02-05T19:17:10.289585
...
Strategies module for algorithmic trading system presentation layer.
...
### Classes (7)
- StrategyConfigRequest(BaseModel)
- StrategyLoadRequest(BaseModel)
- StrategyActivateRequest(BaseModel)
- StrategyUpdateRequest(BaseModel)
- StrategyResponse(BaseModel)
- StrategyMetricsResponse(BaseModel)
- ExecutionStatsResponse(BaseModel)
