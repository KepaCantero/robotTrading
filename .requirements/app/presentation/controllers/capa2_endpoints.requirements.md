# Requirements: presentation/controllers/capa2_endpoints.py

**Module**: capa2_endpoints
**Layer**: 8 - Presentation Controllers/Views
**Line Count**: 696
**Generated**: 2026-02-05T19:17:10.285408
...
Capa2 Endpoints module for algorithmic trading system presentation layer.
...
### Classes (12)
- ProcessInputRequest(BaseModel)
- ProcessInputResponse(BaseModel)
- GenerateProfileRequest(BaseModel)
- GenerateProfileResponse(BaseModel)
- ParametrizeModulesRequest(BaseModel)
- ParametrizeModulesResponse(BaseModel)
- ExecuteBacktestRequest(BaseModel)
- ExecuteBacktestResponse(BaseModel)
- BacktestStatusResponse(BaseModel)
- CompleteWorkflowRequest(BaseModel)
- DeploymentDecisionResponse(BaseModel)
- CompleteWorkflowResponse(BaseModel)

### Functions (3)
- get_input_processor
- get_deploy_decision_orchestrator
