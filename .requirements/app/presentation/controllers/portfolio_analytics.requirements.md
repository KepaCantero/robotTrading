# Requirements: presentation/controllers/portfolio_analytics.py

**Module**: portfolio_analytics
**Layer**: 8 - Presentation Controllers/Views
**Line Count**: 414
**Generated**: 2026-02-05T19:17:10.288030
...
Portfolio Analytics module for algorithmic trading system presentation layer.
...
### Classes (10)
- PerformanceMetricsRequest(BaseModel)
- PerformanceMetricsResponse(BaseModel)
- RiskMetricsResponse(BaseModel)
- PortfolioAnalyticsResponse(BaseModel)
- PortfolioAllocationResponse(BaseModel)
- RebalanceRequest(BaseModel)
- RebalanceResponse(BaseModel)
- PortfolioComparisonRequest(BaseModel)
- PortfolioComparisonResponse(BaseModel)
- AnalyticsSummaryResponse(BaseModel)
