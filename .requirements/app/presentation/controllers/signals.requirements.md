# Requirements: presentation/controllers/signals.py

**Module**: signals
**Layer**: 8 - Presentation Controllers/Views
**Line Count**: 438
**Generated**: 2026-02-05T19:17:10.289090
...
Signals module for algorithmic trading system presentation layer.
...
### Classes (4)
- MarketDataRequest(BaseModel)
- SignalEvaluationRequest(BaseModel)
- SignalResponse(BaseModel)
- SignalStatisticsResponse(BaseModel)

### Functions (1)
- get_signal_scorer_service
