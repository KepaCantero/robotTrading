...
Represents portfolio optimization results combining multiple methodologies (Chan, Narang, Hull).
...
- **File Path:** `/Users/kepa.cantero/Projects/algoTrading/app/domain/entities/portfolio_optimization.py`
- **Total Lines:** 99
- **Has Imports:** True
- **Uses Dataclass:** True
...
grep -E "from sqlalchemy|from fastapi|import httpx" app/domain/app/domain/entities/portfolio_optimization.py | wc -l
# Expected: 0
```
