...
Complete pre-trade analysis from all 17 trading systems (8 main + 12 compliance).
...
- **File Path:** `/Users/kepa.cantero/Projects/algoTrading/app/domain/entities/pre_trade_analysis.py`
- **Total Lines:** 196
- **Has Imports:** True
- **Uses Dataclass:** True
...
**Note:** ✅ Has proper validation in __post_init__ with raise ValueError for all critical fields
...
grep -E "from sqlalchemy|from fastapi|import httpx" app/domain/app/domain/entities/pre_trade_analysis.py | wc -l
# Expected: 0
```
