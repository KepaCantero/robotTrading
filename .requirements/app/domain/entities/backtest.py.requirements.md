...
Core business object for backtesting operations with configuration, execution state, and results.
...
- **File Path:** `/Users/kepa.cantero/Projects/algoTrading/app/domain/entities/backtest.py`
- **Total Lines:** 251
- **Has Imports:** True
- **Uses Dataclass:** True
...
grep -E "from sqlalchemy|from fastapi|import httpx" app/domain/app/domain/entities/backtest.py | wc -l
# Expected: 0
```
