...
## Purpose
 file for multi strategy optimizer
...
**Purpose:** Optimizes parameters for multiple trading strategies simultaneously.

Uses Optuna for Bayesian optim...

---

## Function Signatures (Contracts)

### `MultiStrategyOptimizer.optimize(self, storage, study_name, resume) -> optuna.Study`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `MultiStrategyOptimizer.get_best_config(self) -> Dict[str, Any]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `MultiStrategyOptimizer.run_backtest_with_best_params(self) -> Dict[str, Any]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_multi_strategy_optimizer.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/optimization/multi_strategy_optimizer.py`
**Created:** 2026-02-05
