...
### SensitivityResult
**Purpose:** Result of sensitivity analysis for a single parameter....
### SensitivityReport
**Purpose:** Comprehensive sensitivity analysis report....
### SensitivityAnalyzer
**Purpose:** Analyze parameter sensitivity to identify robust vs critical parameters.

Core concept: Test each pa...

---

## Function Signatures (Contracts)

### `SensitivityResult.to_dict(self) -> Dict[str, Any]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `SensitivityReport.to_dict(self) -> Dict[str, Any]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `SensitivityReport.to_json(self, filepath) -> str`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `SensitivityAnalyzer.analyze_parameter_sensitivity(self, initial_params, performance_metric) -> SensitivityReport`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `SensitivityAnalyzer.get_sensitivity_summary(self, report) -> Dict[str, Any]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `SensitivityAnalyzer.print_sensitivity_report(self, report) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_sensitivity_analyzer.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/optimization/sensitivity_analyzer.py`
**Created:** 2026-02-05
