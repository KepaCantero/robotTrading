...
### `sample_5_asset_returns() -> NDArray[np.float64]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `sample_5_asset_caps() -> NDArray[np.float64]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `sample_5_asset_weights() -> NDArray[np.float64]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `sample_5_asset_covariance() -> NDArray[np.float64]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `relative_view_0_1() -> InvestorView`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `sample_views() -> list[InvestorView]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_conftest.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/tests/portfolio_optimization/conftest.py`
**Created:** 2026-02-05
