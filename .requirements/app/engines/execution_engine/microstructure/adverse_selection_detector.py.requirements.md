# Requirements: engines/execution_engine/microstructure/adverse_selection_detector.py

## Source File Analysis
- **File Path**: `app/engines/execution_engine/microstructure/adverse_selection_detector.py`
- **Lines of Code**: 583
