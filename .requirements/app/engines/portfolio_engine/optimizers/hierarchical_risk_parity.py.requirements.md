# Requirements: engines/portfolio_engine/optimizers/hierarchical_risk_parity.py

## Source File Analysis
- **File Path**: `app/engines/portfolio_engine/optimizers/hierarchical_risk_parity.py`
- **Lines of Code**: 731
