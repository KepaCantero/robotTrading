# low_beta_screener.py

## Purpose
 file for low beta screener
...
### LowBetaScreener
**Purpose:** Screener de acciones de baja volatilidad.

Filtra universo de acciones basado en criterios de volati...

---

## Function Signatures (Contracts)

### `LowBetaScreener.screen(self, profiles) -> ScreeningResult`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `LowBetaScreener.get_sector_defensive_level(self, sector) -> SectorDefensiveLevel`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_low_beta_screener.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/low_volatility/low_beta_screener.py`
**Created:** 2026-02-05
