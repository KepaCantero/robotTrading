...
### CryptoScreener
**Purpose:** Screen crypto assets for momentum strategy.

This class implements screening logic for cryptocurrenc...

---

## Function Signatures (Contracts)

### `CryptoScreener.screen(self, universe, min_market_cap, min_daily_volume, min_liquidity_score, max_volatility, required_exchanges, asset_types) -> CryptoScreeningResult`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CryptoScreener.calculate_liquidity_score(self, asset) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CryptoScreener.verify_listing(self, symbol, major_exchanges) -> bool`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CryptoScreener.calculate_btc_correlation_score(self, asset) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CryptoScreener.get_screening_summary(self) -> Dict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_crypto_screener.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/crypto_momentum/crypto_screener.py`
**Created:** 2026-02-05
