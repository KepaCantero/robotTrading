...
### DividendFrequency
**Purpose:** Dividend payment frequency....
### DividendSafety
**Purpose:** Dividend safety assessment....
### DividendAristocratStatus
**Purpose:** Dividend aristocrat status based on consecutive years of increases....
### DividendData
**Purpose:** Datos fundamentales de dividendos de una acción.

Attributes:
    symbol: Símbolo de la acción
    a...
### ExDividendDate
**Purpose:** Información de fecha ex-dividendo.

Attributes:
    symbol: Símbolo de la acción
    ex_dividend_dat...
### DividendProfile
**Purpose:** Perfil completo de dividendos de una acción.

Combina datos actuales con histórico y análisis....
### DividendStock
**Purpose:** Acción de dividendos con datos para toma de decisiones.

Extiende DividendProfile con scores de deci...
### DividendStrategyConfig
**Purpose:** Configuración de la estrategia de dividendos.

Define parámetros para screening, análisis y construc...
### DividendScreeningCriteria
**Purpose:** Criterios de screening des-normalizados desde config....
### ScreeningResult
**Purpose:** Resultado del screening de dividendos.

Attributes:
    passed_stocks: Lista de acciones que pasaron...

---

## Function Signatures (Contracts)

### `DividendData.validate_yield(cls, v) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendData.safety(self) -> DividendSafety`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendData.aristocrat_status(self) -> DividendAristocratStatus`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendData.monthly_dividend_estimate(self) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `ExDividendDate.days_until_ex_dividend(self, today) -> int`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendProfile.is_dividend_trap(self) -> bool`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendProfile.overall_score(self) -> Optional[Decimal]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendStrategyConfig.validate_weights_sum(self) -> 'DividendStrategyConfig'`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendStrategyConfig.validate_yield_range(self) -> 'DividendStrategyConfig'`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendStrategyConfig.get_screening_description(self) -> str`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
**File Reference:** `app/strategies/dividend/models.py`
**Created:** 2026-02-05
