...
**Purpose:** Score de calidad de dividendo (0-100).

Combina múltiples factores:
- Yield ajustado por riesgo
- Cr...
### DividendSustainabilityMetrics
**Purpose:** Métricas de sostenibilidad de dividendos.

Evalúa la capacidad de la empresa para:
- Mantener el div...
### DividendAnalyzer
**Purpose:** Analizador de calidad y sostenibilidad de dividendos.

Proporciona análisis detallado para evaluar l...

---

## Function Signatures (Contracts)

### `DividendAnalyzer.analyze_quality(self, profile) -> DividendQualityScore`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendAnalyzer.analyze_sustainability(self, profile, historical_data) -> DividendSustainabilityMetrics`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendAnalyzer.analyze_yield_on_cost(self, profile, purchase_price, years_held) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `DividendAnalyzer.project_dividend_income(self, profile, investment_amount, years, growth_rate) -> List[Tuple[int, Decimal, Decimal]]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_dividend_analyzer.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/dividend/dividend_analyzer.py`
**Created:** 2026-02-05
