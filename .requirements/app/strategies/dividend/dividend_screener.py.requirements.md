...
### DividendScreener
**Purpose:** Screener de acciones de dividendos.
...
### `DividendScreener.screen(self, profiles) -> ScreeningResult`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_dividend_screener.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/dividend/dividend_screener.py`
**Created:** 2026-02-05
