...
**Purpose:** Construct factor-tilted portfolios using optimization.

The optimizer aims to:
1. Achieve target fac...

---

## Function Signatures (Contracts)

### `FactorPortfolioConstructor.construct_portfolio(self, profiles, factor_scores_dict, total_capital) -> FactorPortfolio`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `FactorPortfolioConstructor.rebalance(self, current_portfolio, profiles, factor_scores_dict, total_capital) -> FactorPortfolio`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `FactorPortfolioConstructor.analyze_drift(self, portfolio, factor_scores_dict) -> FactorRebalanceRecommendation`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `FactorPortfolioConstructor.get_portfolio_metrics(self, portfolio) -> Dict[str, Any]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
**File Reference:** `app/strategies/multi_factor/portfolio_constructor.py`
**Created:** 2026-02-05
