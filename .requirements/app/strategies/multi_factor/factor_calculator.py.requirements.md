...
### FactorCalculator
**Purpose:** Calculator for Fama-French factor scores.

Computes standardized factor scores for a universe of sto...

---

## Function Signatures (Contracts)

### `FactorCalculator.calculate_factor_scores(self, profiles) -> Dict[str, FactorScores]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `FactorCalculator.get_factor_statistics(self) -> Dict[str, Dict[str, float]]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `FactorCalculator.calculate_predicted_returns(self, factor_scores_dict, factor_premiums, risk_free_rate) -> Dict[str, Decimal]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `get_default_factor_premiums() -> Dict[str, float]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_factor_calculator.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/multi_factor/factor_calculator.py`
**Created:** 2026-02-05
