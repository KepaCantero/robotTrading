...
## Purpose
 file for covered call strategy
...
### CoveredCallStrategy
**Purpose:** Estrategia de covered calls.
...
### `CoveredCallStrategy.generate_signals(self, market_data) -> List[Signal]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CoveredCallStrategy.risk_check(self, signal, portfolio) -> bool`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CoveredCallStrategy.get_required_parameters(self) -> List[str]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CoveredCallStrategy.validate_config(self) -> bool`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CoveredCallStrategy.set_available_options(self, options) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CoveredCallStrategy.create_covered_call_position(self, symbol, shares_owned, average_cost, current_price, strike, dte) -> Optional[CoveredCallPosition]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CoveredCallStrategy.get_position_summary(self) -> Dict[str, Any]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CoveredCallStrategy.analyze_roll_opportunities(self, symbol, current_price) -> List[Dict[str, Any]]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_covered_call_strategy.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/covered_calls/covered_call_strategy.py`
**Created:** 2026-02-05
