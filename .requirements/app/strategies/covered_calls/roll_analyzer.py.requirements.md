...
### RollAnalyzer
**Purpose:** Analizador de oportunidades de rolling.

Evalúa si vale la pena hacer roll de una posición covered c...

---

## Function Signatures (Contracts)

### `RollAnalyzer.analyze_roll_opportunities(self, position, current_price, available_options) -> List[RollOpportunity]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `RollAnalyzer.should_roll(self, position, current_price, opportunities) -> Tuple[bool, Optional[RollOpportunity]]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `RollAnalyzer.calculate_roll_metrics(self, position, opportunity) -> dict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_roll_analyzer.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/covered_calls/roll_analyzer.py`
**Created:** 2026-02-05
