...
**Purpose:** Identified carry trade opportunity.

Represents a potential carry trade with expected returns and
co...
### CarryCalculator
**Purpose:** Calculator for FX carry trade signals and opportunities.

Implements Ilmanen's carry trade methodolo...

---

## Function Signatures (Contracts)

### `CarryTradeOpportunity.is_actionable(self) -> bool`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CarryCalculator.calculate_forward_premium(self, spot_rate, forward_rate) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CarryCalculator.calculate_carry(self, interest_rate_diff, forward_premium) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CarryCalculator.calculate_signal(self, carry) -> float`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CarryCalculator.calculate_signal_full(self, pair, spot_rate, forward_rate, interest_rate_diff, timestamp, months) -> FXCarrySignal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CarryCalculator.filter_signals(self, signals, min_abs_signal) -> dict[FXPair, FXCarrySignal]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CarryCalculator.rank_signals(self, signals) -> list[tuple[FXPair, FXCarrySignal]]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `CarryCalculator.calculate_signals_from_provider(self, pairs, provider, as_of, months) -> dict[FXPair, FXCarrySignal]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_carry_calculator.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/fx_carry_trade/carry_calculator.py`
**Created:** 2026-02-05
