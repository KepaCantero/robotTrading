...
### EMAFilter
**Purpose:** Filtro de tendencia usando Exponential Moving Averages.
...
## Required Tests
- **test_ema_filter.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/filters/ema_filter.py`
**Created:** 2026-02-05
