...
### MomentumFilter
**Purpose:** Filtro de momentum basado en Rate of Change.

Evalúa si hay suficiente momentum positivo (para compr...
...
## Required Tests
- **test_momentum_filter.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/filters/momentum_filter.py`
**Created:** 2026-02-05
