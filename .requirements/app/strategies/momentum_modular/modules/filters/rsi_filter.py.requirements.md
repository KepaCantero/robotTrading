...
### RSIFilter
**Purpose:** Filtro de momentum usando Relative Strength Index (RSI).
...
### `RSIFilter.clear_rsi_history(cls, symbol) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `RSIFilter.get_rsi_history(cls) -> Dict[str, float]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_rsi_filter.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/filters/rsi_filter.py`
**Created:** 2026-02-05
