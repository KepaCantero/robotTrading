...
### VolumeFilter
**Purpose:** Filtro de volumen que valida que haya suficiente actividad de trading.

Compara volumen actual vs pr...
...
## Required Tests
- **test_volume_filter.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/filters/volume_filter.py`
**Created:** 2026-02-05
