...
### StochRSIFilter
**Purpose:** Filtro Stochastic RSI para detectar condiciones de sobrecompra/sobreventa más precisas.
...
## Required Tests
- **test_stoch_rsi_filter.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/filters/stoch_rsi_filter.py`
**Created:** 2026-02-05
