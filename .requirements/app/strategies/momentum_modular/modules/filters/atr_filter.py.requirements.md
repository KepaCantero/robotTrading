...
### ATRFilter
**Purpose:** Filtro ATR que valida que haya suficiente volatilidad para operar.

Puede usar ATR absoluto, relativ...
...
## Required Tests
- **test_atr_filter.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/filters/atr_filter.py`
**Created:** 2026-02-05
