...
### MarketAnalyzer
**Purpose:** Orquesta módulos de detección de régimen de mercado.
...
### `MarketAnalyzer.analyze(self, market_data, price_history, atr_history) -> Dict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_market_analyzer.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/market_analyzer.py`
**Created:** 2026-02-05
