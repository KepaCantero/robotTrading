...
### VolatilityDetector
**Purpose:** Detecta régimen de volatilidad: high, normal, low.

Métodos soportados:
- atr_percentile: Percentil ...

---

## Function Signatures (Contracts)

### `VolatilityDetector.detect(self, price_history) -> Dict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_volatility_detector.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/market_detectors/volatility_detector.py`
**Created:** 2026-02-05
