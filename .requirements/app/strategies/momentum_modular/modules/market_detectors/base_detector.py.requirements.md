...
### BaseMarketDetector
**Purpose:** Interfaz base para todos los detectores de régimen de mercado.

Cada detector es un módulo independi...

---

## Function Signatures (Contracts)

### `BaseMarketDetector.detect(self, price_history) -> Dict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `BaseMarketDetector.is_enabled(self) -> bool`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_base_detector.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/market_detectors/base_detector.py`
**Created:** 2026-02-05
