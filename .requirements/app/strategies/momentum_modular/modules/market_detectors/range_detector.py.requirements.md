...
### RangeDetector
**Purpose:** Detecta si el mercado está en rango lateral.

Métodos soportados:
- bollinger_squeeze: Bandas de Bol...

---

## Function Signatures (Contracts)

### `RangeDetector.detect(self, price_history) -> Dict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_range_detector.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/market_detectors/range_detector.py`
**Created:** 2026-02-05
