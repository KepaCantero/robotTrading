...
### BaseFilter
**Purpose:** Interfaz base para todos los filtros modulares.

Cada filtro puede:
- Activarse/desactivarse según e...

---

## Function Signatures (Contracts)

### `BaseFilter.evaluate(self, indicators, market_context, signal_type) -> Dict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_base_filter.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/modules/base_filter.py`
**Created:** 2026-02-05
