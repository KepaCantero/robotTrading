...
### RateLimitedLogger
**Purpose:** Logger que solo imprime warnings cada N veces para evitar spam....
### ModularMomentumStrategy
**Purpose:** Estrategia de momentum completamente modular con learning engines integrado.
...
### `RateLimitedLogger.warning(self, msg, key) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `ModularMomentumStrategy.generate_signals(self, market_data) -> List[Signal]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `ModularMomentumStrategy.add_trade_result(self, trade) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `ModularMomentumStrategy.risk_check(self, signal, portfolio) -> bool`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `ModularMomentumStrategy.get_required_parameters(self) -> List[str]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `ModularMomentumStrategy.get_position_size(self, signal, portfolio) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_strategy.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/strategies/momentum_modular/strategy.py`
**Created:** 2026-02-05
