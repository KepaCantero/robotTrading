# profit_factor_validator.py

## Purpose
Implementation for profit_factor_validator
...
**Purpose:** Validates Profit Factor criterion.
...
### `ProfitFactorValidator.validate(self, profit_factor) -> CriterionResult`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_profit_factor_validator.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/backtesting/acceptance/profit_factor_validator.py`
**Created:** 2026-02-05
