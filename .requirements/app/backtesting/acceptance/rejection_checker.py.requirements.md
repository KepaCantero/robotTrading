# rejection_checker.py

## Purpose
Implementation for rejection_checker
...
**Purpose:** Checks rejection criteria for strategy acceptance.

Rejection criteria:
- Commission Impact <= 20% o...

---

## Function Signatures (Contracts)

### `RejectionCriteriaChecker.check_commission_impact(self, commission_impact) -> Optional[CriterionResult]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `RejectionCriteriaChecker.check_failed_regimes(self, failed_regimes) -> Optional[CriterionResult]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `RejectionCriteriaChecker.check_equity_curve_trend(self, equity_curve_last_years) -> Optional[CriterionResult]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `RejectionCriteriaChecker.check_all(self, commission_impact, failed_regimes, equity_curve_last_years) -> List[CriterionResult]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_rejection_checker.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/backtesting/acceptance/rejection_checker.py`
**Created:** 2026-02-05
