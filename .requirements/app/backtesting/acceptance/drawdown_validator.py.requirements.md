# drawdown_validator.py

## Purpose
Implementation for drawdown_validator
...
### DrawdownValidator
**Purpose:** Validates Maximum Drawdown criterion.
...
### `DrawdownValidator.validate(self, max_drawdown) -> CriterionResult`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_drawdown_validator.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/backtesting/acceptance/drawdown_validator.py`
**Created:** 2026-02-05
