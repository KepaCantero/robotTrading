...
### VerdictStatus
**Purpose:** Strategy verdict status....
### CriterionResult
**Purpose:** Result of a single criterion check....
### AcceptanceReport
**Purpose:** Complete acceptance criteria report....
...
**File Reference:** `app/backtesting/acceptance/models.py`
**Created:** 2026-02-05
