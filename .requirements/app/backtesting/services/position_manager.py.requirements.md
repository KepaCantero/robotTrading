...
## Purpose
Implementation for position_manager
...
### PositionManager
**Purpose:** Track and manage open positions during backtesting.

This service handles:
- Position state manageme...

---

## Function Signatures (Contracts)

### `PositionManager.__init__(self) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.get_position(self, symbol) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.update_position(self, symbol, quantity_delta) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.set_position(self, symbol, quantity) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.close_position(self, symbol) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.has_open_position(self, symbol) -> bool`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.get_all_positions(self) -> Dict[str, Decimal]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.get_symbols_with_positions(self) -> List[str]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.clear_all_positions(self) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.get_total_position_count(self) -> int`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PositionManager.get_total_position_value(self, price_func) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
**File Reference:** `app/backtesting/services/position_manager.py`
**Created:** 2026-02-05
