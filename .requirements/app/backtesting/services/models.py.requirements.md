...
### ProfileResultDB
**Purpose:** Database model for profile results.

Stores baseline and optimization results for each investor prof...
### BaselineOptimizationComparison
**Purpose:** Comparison between baseline and optimized results.

Attributes:
    sharpe_improvement: Percentage i...
### OptimizedStrategy
**Purpose:** Result of optimization pipeline.

Contains complete results from running optimization including
base...
### ProfileResult
**Purpose:** Complete result for a single profile.

Contains all results from running a single investor profile t...

---

## Function Signatures (Contracts)

### `ProfileResultDB.to_dict(self) -> ConfigDict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
**File Reference:** `app/backtesting/services/models.py`
**Created:** 2026-02-05
