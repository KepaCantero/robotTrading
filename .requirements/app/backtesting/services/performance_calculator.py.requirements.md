...
## Purpose
Implementation for performance_calculator
...
### `PerformanceMetricsCalculator.__init__(self, config) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PerformanceMetricsCalculator.calculate_performance_metrics(self, trades, max_drawdown, initial_capital) -> PerformanceMetrics`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PerformanceMetricsCalculator._calculate_sharpe_ratio(self, trades) -> Optional[Decimal]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PerformanceMetricsCalculator._create_empty_metrics(self, initial_capital) -> PerformanceMetrics`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PerformanceMetricsCalculator.calculate_win_rate(self, trades) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PerformanceMetricsCalculator.calculate_profit_factor(self, trades) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `PerformanceMetricsCalculator.calculate_expectancy(self, trades) -> Decimal`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_performance_calculator.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/backtesting/services/performance_calculator.py`
**Created:** 2026-02-05
