...
### TaxResidence
**Purpose:** Tax residence configuration for the investor.

Critical for:
- Tax rate calculation
- Withholding ta...
### InputProfile
**Purpose:** Parsed and validated user input for parametrization framework.

This is the entry point to the syste...
### InputProcessor
**Purpose:** Parse and validate user inputs into InputProfile.

This is the foundation task (T1.1) - no dependenc...

---

## Function Signatures (Contracts)

### `InputProfile.validate_capital(cls, v) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `InputProfile.validate_objetivo(cls, v) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `InputProfile.validate_horizon(cls, v) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `InputProfile.validate_risk_tolerance(cls, v) -> None`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `InputProfile.capital_flag(self) -> str`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `InputProfile.is_large_account(self) -> bool`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `InputProfile.to_dict(self) -> dict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `InputProcessor.process_input(self, user_input) -> InputProfile`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `InputProcessor.validate_consistency(self, profile) -> tuple[bool, list[str]]`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
### `InputProcessor.get_stats(self) -> dict`
**Pre:** TBD
**Post:** TBD
**Raises:** TBD
**Retry:** ❌ No
...
## Required Tests
- **test_input_profile.py:** Test descriptions to be defined during audit
...
**File Reference:** `app/core/models/input_profile.py`
**Created:** 2026-02-05
