...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("COMPLIANCE-AWARE TRADING WRAPPERS")
    print("=" * 80)
    print("\nAll wrappers use THE ComplianceEngine:")
    print("  1. ComplianceAwareBacktester - For backtesting")
    print("  2. ComplianceAwareLiveTrader - For live trading")
    print("  3. ComplianceAwarePaperTrader - For paper trading")
    print("\nConvenience functions:")
    print("  - wrap_backtester()")
    print("  - wrap_live_trader()")
    print("  - wrap_paper_trader()")
    print("=" * 80)
