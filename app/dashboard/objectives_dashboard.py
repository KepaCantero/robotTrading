    ...
    for tab_idx, metric_name in enumerate(OBJECTIVES.keys()):
        with tabs[tab_idx]:
            ...
            if plotly_available:
                ...
                if obj['operator'] == '>':
                    fig.add_hline(y=obj['target'], line_dash="dash", line_color="blue", 
                                annotation_text=f"Objetivo: >{obj['target']}")
                elif obj['operator'] == '<':
                    fig.add_hline(y=obj['target'], line_dash="dash", line_color="blue",
                                annotation_text=f"Objetivo: <{obj['target']}")
                elif obj['operator'] == 'range':
                    fig.add_hline(y=obj['target_min'], line_dash="dash", line_color="blue",
                                annotation_text=f"Min: {obj['target_min']}")
                    fig.add_hline(y=obj['target_max'], line_dash="dash", line_color="blue",
