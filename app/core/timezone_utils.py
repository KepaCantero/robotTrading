...
def to_market_time(dt: datetime, market: str) -> datetime:
    ...
    Example:
        >>> from app.core.timezone_utils import to_market_time, utc_now
        >>> now = utc_now()
...
def format_utc(dt: datetime, fmt: str = "%Y-%m-%d %H:%M:%S %Z") -> str:
    ...
    Example:
        >>> from app.core.timezone_utils import utc_now, format_utc
        >>> now = utc_now()
...
def format_market_time(dt: datetime, market: str, fmt: str = "%Y-%m-%d %H:%M:%S %Z") -> str:
    ...
    Example:
        >>> from app.core.timezone_utils import utc_now, format_market_time
        >>> now = utc_now()
...
def get_market_timezone(market: str) -> timezone:
    ...
    Example:
        >>> from app.core.timezone_utils import get_market_timezone
...
def get_market_open_close_time(
    ...
    Example:
        >>> from app.core.timezone_utils import get_market_open_close_time
...
def validate_timezone_aware(dt: datetime, param_name: str = "datetime") -> None:
    ...
    Example:
        >>> from datetime import datetime
        >>> from app.core.timezone_utils import validate_timezone_aware
...
def ensure_timezone_aware(dt: datetime, param_name: str = "datetime") -> datetime:
    ...
    Example:
        >>> from datetime import datetime
        >>> from app.core.timezone_utils import ensure_timezone_aware
        >>> naive = datetime(2024, 1, 1, 12, 0)
...
def get_db_timestamp_default():
    ...
    Example:
        ...
        >>> from app.core.timezone_utils import get_db_timestamp_default
...
def get_db_timestamp_onupdate():
    ...
    Example:
        >>> from sqlalchemy import Column, TIMESTAMP
        >>> from app.core.timezone_utils import get_db_timestamp_onupdate
...
def to_local_timezone(dt: datetime, local_tz: Optional[timezone] = None) -> datetime:
    ...
    Example:
        >>> from app.core.timezone_utils import utc_now, to_local_timezone
        >>> now = utc_now()
...
def format_for_display(dt: datetime, local_tz: Optional[timezone] = None) -> str:
    ...
    Example:
        >>> from app.core.timezone_utils import utc_now, format_for_display
        >>> now = utc_now()
