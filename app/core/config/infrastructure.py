...
from app.core.config.base import ConfigBase, SettingsBase
...
class DatabaseConfig(SettingsBase):
    ...
    questdb_port: int = Field(default=8812, description="QuestDB port")
...
class MonitoringConfig(ConfigBase):
    ...
    # Grafana
    grafana_enabled: bool = Field(default=False, description="Enable Grafana dashboards")
