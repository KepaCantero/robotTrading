...
class SignalDiagnosticLogger:
    ...
    def __init__(self, output_dir: Path = Path("docs/BACKTEST_RESULTS/diagnostics")):
        ...
        self.strategy_stats: Dict[str, Dict[str, int]] = defaultdict(lambda: {
    ...
    def log_signal_candidate(
        ...
        logger.debug(
            f"[{strategy_name}] Signal candidate: {symbol} {signal_type}"
        )
    ...
    def log_signal_rejected(
        ...
        logger.debug(
            f"[{strategy_name}] Signal rejected: {symbol} - {reason}"
        )
    ...
    def log_signal_executed(
        ...
        logger.debug(
            f"[{strategy_name}] Signal executed: {symbol}"
        )
    ...
    def save_diagnostic_report(self, filename: str = None) -> Path:
        ...
        report = {
            ...
            "top_rejected_symbols": sorted(
                [
                    {"symbol": s, **stats}
                    for s, stats in self.symbol_stats.items()
                ],
