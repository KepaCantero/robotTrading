...
class BacktestResultsProcessor:
    ...
    def get_best_result(self, metric: str = "total_return_pct") -> BacktestResultValue | None:
        """
    ...
    def get_worst_result(self, metric: str = "total_return_pct") -> BacktestResultValue | None:
        """
    ...
    def get_percentile(self, percentile: float, metric: str = "total_return_pct") -> Decimal | None:
        """
    ...
    def get_results_dataframe(self) -> pd.DataFrame | None:
        """
    ...
    def compare_to_benchmark(self, benchmark_return: Decimal) -> dict[str, Any] | None:
        """
