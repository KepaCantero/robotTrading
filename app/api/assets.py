...
async def get_asset_by_symbol(
    ...
    """Get asset by symbol."""
    try:
        asset = await service.get_asset_by_symbol(symbol.upper(), asset_class)
    ...
    try:
        ...
        return {
            ...
            "filter_criteria": {
                ...
                "exchanges": [ex.value for ex in filter_criteria.exchanges] if filter_criteria.exchanges else None,
...
async def get_asset_stats(
    ...
    try:
        ...
        for asset_class in AssetClass:
            ...
            total_liquidity += summary.get("avg_liquidity_score", 0.0) * summary.get("total_assets", 0)
            active_assets += len([a for a in summary.get("top_assets", []) if a.get("is_active", True)])
