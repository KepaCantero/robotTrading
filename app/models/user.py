...
class User(Base):
    ...
    role: Mapped[UserRole] = mapped_column(
        SQLEnum(UserRole), default=UserRole.TRADER, nullable=False
    )
...
class Account(Base):
    ...
    account_type: Mapped[str] = mapped_column(
        String(50), default="trading", nullable=False
    )
    ...
    max_position_size: Mapped[Optional[float]] = mapped_column(
    ...
    available_balance: Mapped[float] = mapped_column(
        Numeric(15, 2), default=0.0, nullable=False
    )
    ...
    def can_trade(self) -> bool:
        ...
        """
        return self.is_active and self.available_balance > 0 and self.user.is_active
