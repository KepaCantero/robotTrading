...
class MomentumStrategy(BaseStrategy):
    ...
    def _is_buy_signal(self, rsi: Decimal, ema_trend: Decimal, 
                      volume_ratio: Decimal, market_data: Quote) -> bool:
        """
        ...
        """
        return (
            rsi < self.rsi_threshold and  # RSI oversold
            ema_trend > self.momentum_threshold and  # Tendencia alcista
            volume_ratio > self.volume_threshold  # Volumen alto
        )
    
    def _is_sell_signal(self, rsi: Decimal, ema_trend: Decimal,
                       volume_ratio: Decimal, market_data: Quote) -> bool:
        """
        ...
        """
        return (
            rsi > (100 - self.rsi_threshold) and  # RSI overbought
            ema_trend < -self.momentum_threshold and  # Tendencia bajista
            volume_ratio > self.volume_threshold  # Volumen alto
        )
