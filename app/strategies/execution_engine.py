...
class ExecutionEngine:
    ...
    def run_cycle(self, market_data: Quote, portfolio: Portfolio) -> List[Signal]:
        ...
        try:
            ...
            logger.debug(f"Strategy '{active_strategy.name}' generated {len(strategy_signals)} signals")
    ...
    def execute_signal(self, signal: Signal, execution_price: Optional[Decimal] = None) -> bool:
        ...
        try:
            ...
            logger.info(f"Signal executed: {signal.symbol} {signal.signal_type} at {execution_price or signal.price}")
            return True
    ...
    def execute_signals(self, signals: List[Signal], 
                       execution_prices: Optional[Dict[str, Decimal]] = None) -> Dict[str, bool]:
        """
    ...
    def get_execution_stats(self) -> Dict[str, Any]:
        ...
        """
        execution_rate = (self.total_signals_executed / self.total_signals_generated 
        ...
        try:
            ...
            for position in portfolio.positions:
                if position.quantity < 0:
                    logger.error(f"Invalid position quantity for {position.symbol}: {position.quantity}")
                    return False
    ...
    def run_cycle_with_validation(self, market_data: Quote, 
