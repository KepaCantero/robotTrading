...
class StrategyLogger:
    ...
    def _create_log_entry(self, event: str, strategy_name: str, 
                          level: str = "INFO", **kwargs) -> Dict[str, Any]:
        """
    ...
    def log_signal_executed(self, strategy_name: str, signal: Signal, 
    ...
    def log_strategy_error(self, strategy_name: str, error: str, 
    ...
    def log_execution_error(self, strategy_name: str, signal: Signal, 
                           error: str) -> None:
        """
