...
from app.services.scheduling.market_scheduler import MarketScheduler, MarketType
    ...
    def generate_signals(self, market_data: Quote) -> List[Signal]:
        ...
        try:
            ...
            if not self._should_execute_at_fixed_timestamp():
                logger.debug(f"CARVER {market_data.symbol}: Skipping - not at fixed execution time")
                return []
