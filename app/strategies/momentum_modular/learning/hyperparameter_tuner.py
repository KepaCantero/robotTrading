...
class ResourceAwareTuner:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"ResourceAwareTuner: GPU={self.gpu_available}, Max trials={self.max_trials}, Max time={self.max_time_seconds}s")
...
class HyperparameterTuner:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        # Early stopping
        self.early_stopping = EarlyStoppingAdaptive(
            config.get('early_stopping_config', {})
        )
        
        # Resource-aware tuning
        self.resource_manager = ResourceAwareTuner(
            config.get('resource_config', {})
        )
    ...
    def visualize_optimization(self, output_path: Optional[str] = None) -> None:
        ...
        try:
            ...
            logger.warning("optuna.visualization no disponible. Instalar 'plotly' para visualizaciones")
        except Exception as e:
...
class LearningEngineTuner:
    ...
    def __init__(self, learning_engine_class: type, engine_config: Dict[str, Any], tuner_config: Dict[str, Any]):
        """
