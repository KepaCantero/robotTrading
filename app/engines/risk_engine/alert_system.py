...
class AlertSystem(BaseAlertSystem):
    ...
    def check_thresholds(
        ...
        try:
            ...
            if 'drawdown' in risk_assessment:
                drawdown_alerts = self._check_drawdown_thresholds(
            ...
            if 'exposure' in risk_assessment:
                exposure_alerts = self._check_exposure_thresholds(
                    risk_assessment['exposure']
                )
    ...
    def _check_drawdown_thresholds(
        self,
    ...
    def _check_exposure_thresholds(
        self,
