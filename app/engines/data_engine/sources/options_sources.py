...
class OptionsVolatilitySource(BaseDataSource):
    ...
    async def _get_polygon_option_chain(self, symbol: str, expiry_date: Optional[datetime]) -> List[Dict[str, Any]]:
    ...
    async def get_volatility_surface(
        ...
        try:
            ...
            if expiry_dates:
                ...
                expiry_dates = [ed for ed in expiry_dates if ed in [opt['expiry_date'] for opt in option_chains]]
