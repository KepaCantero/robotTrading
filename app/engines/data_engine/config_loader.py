...
class DataEngineConfigLoader:
    ...
    def get_cache_config(self, env_redis_url: Optional[str] = None, env_postgres_url: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def get_streaming_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'connection_reason_max_reached': streaming_config.get('connection_reason_max_reached', 'Maximum connections reached')
        }
    ...
    def get_sentiment_config(self, source_name: str = None) -> Dict[str, Any]:
        ...
        config = {
            ...
            'default_counts': sentiment_config.get('default_counts', {
                'positive': 0,
                'negative': 0,
                'neutral': 0,
                'total': 0
        ...
        if source_name and source_name in sources_config:
            ...
            config.update({
                ...
                'default_sentiment_values': source_specific.get('default_sentiment_values', {
                    'positive': 0.5,
                    'negative': -0.5,
                    'neutral': 0.0
                })
