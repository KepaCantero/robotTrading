...
class GapInterpolator:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        """
        config = config or {}
        self.method = config.get('method', 'forward_fill')  # forward_fill, backward_fill, linear, spline
        self.max_gap_days = config.get('max_gap_days', 5)  # Máximo de días para interpolar
        self.interpolate_volume = config.get('interpolate_volume', False)  # Interpolar volumen (generalmente 0)
