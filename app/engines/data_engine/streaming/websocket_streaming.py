...
class WebSocketStreamingManager:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.connection_reason_max_reached = config.get('connection_reason_max_reached', 'Maximum connections reached')
        ...
        logger.info(f"WebSocketStreamingManager inicializado (max_connections={self.max_connections})")
    ...
    async def handle_connection(self, websocket: WebSocket, client_id: str) -> None:
        ...
        if len(self.active_connections) >= self.max_connections:
            await websocket.close(code=self.max_connection_code, reason=self.connection_reason_max_reached)
            return
