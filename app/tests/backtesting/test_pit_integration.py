...
class TestLookAheadValidator:
    ...
    def test_validate_backtest_no_bias(self, validator, sample_signals, sample_market_data_extended):
    ...
    def test_check_future_data_leakage(self, validator):
        ...
        signals = pd.DataFrame({
            'close': [103.0]  # Matches future value
        }, index=signal_dates[:1])
    ...
    def test_check_index_alignment_valid(self, validator, sample_signals, sample_market_data_extended):
...
class TestPITIntegration:
    ...
    def test_validator_respects_check_flags(self):
        ...
        validator = LookAheadValidator(
            ...
            check_future_leakage=False
        )
        
        signals = pd.DataFrame({'signal': [1]}, 
