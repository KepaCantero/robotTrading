...
# ============================================================================
# TypedDict classes for type documentation (P1)
# ============================================================================


class UserDict(TypedDict, total=False):
    """Type hint for user data dictionaries."""
...
class APIKeyDict(TypedDict, total=False):
    """Type hint for API key data dictionaries."""

    hashed_key: str
    username: str


class FailedAttemptsDict(TypedDict, total=False):
    """Type hint for failed attempts tracking dictionaries."""

    identifier: str
    count: int


class LockoutsDict(TypedDict, total=False):
    """Type hint for lockout tracking dictionaries."""
...
class RateLimitsDict(TypedDict, total=False):
    """Type hint for rate limit tracking dictionaries."""
