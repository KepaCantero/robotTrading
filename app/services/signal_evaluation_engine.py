...
class SignalEvaluationEngine:
    ...
    def _calculate_strength_score(
        ...
        # Score basado en volatilidad (mayor volatilidad = mayor fuerza potencial)
    ...
    def _is_signal_acceptable(
        ...
        return (
            strength_score >= self.min_signal_strength and
            confidence_score >= self.min_signal_confidence and
    ...
    def get_evaluation_statistics(self) -> Dict[str, Any]:
        ...
        acceptance_rate = (
            self.accepted_signals / total_evaluations 
