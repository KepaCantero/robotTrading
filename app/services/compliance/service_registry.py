...
class ComplianceService(Protocol):
    """Marker protocol for compliance subsystem services.

    All compliance subsystems are structurally typed - any object
    qualifies as a ComplianceService. This Protocol exists to
    replace bare `Any` with a meaningful type annotation.
    """
...
ServiceFactory = Callable[[], Optional[ComplianceService]]
...
class ComplianceServiceRegistry:
    ...
    def __init__(self) -> None:
        ...
        self._services: dict[str, ComplianceService | None] = {}
    ...
    def get_service(self, service_name: str) -> ComplianceService | None:
        """
    ...
    def get_all_services(self) -> dict[str, ComplianceService]:
        """
    ...
    def _create_regime_detector(self) -> ComplianceService | None:
        try:
    ...
    def _create_vwap_executor(self) -> ComplianceService | None:
        try:
    ...
    def _create_twap_executor(self) -> ComplianceService | None:
        try:
            from app.domain.services.execution.algorithms import get_execution_algorithm
    ...
    def _create_is_executor(self) -> ComplianceService | None:
        try:
            from app.domain.services.execution.algorithms import get_execution_algorithm
    ...
    def _create_pov_executor(self) -> ComplianceService | None:
        try:
            from app.domain.services.execution.algorithms import get_execution_algorithm
    ...
    def _create_portfolio_optimizer(self) -> ComplianceService | None:
        try:
    ...
    def _create_alpha_model(self) -> ComplianceService | None:
        try:
    ...
    def _create_risk_model(self) -> ComplianceService | None:
        try:
    ...
    def _create_cost_model(self) -> ComplianceService | None:
        try:
    ...
    def _create_portfolio_constructor(self) -> ComplianceService | None:
        try:
    ...
    def _create_execution_engine_narang(self) -> ComplianceService | None:
        try:
    ...
    def _create_meta_labeling(self) -> ComplianceService | None:
        try:
    ...
    def _create_purged_cv(self) -> ComplianceService | None:
        try:
    ...
    def _create_harris_integrator(self) -> ComplianceService | None:
        try:
    ...
    def _create_order_book_analyzer(self) -> ComplianceService | None:
        try:
    ...
    def _create_dark_pool_router(self) -> ComplianceService | None:
        try:
    ...
    def _create_order_flow_analyzer(self) -> ComplianceService | None:
        try:
    ...
    def _create_liquidity_analyzer(self) -> ComplianceService | None:
        try:
    ...
    def _create_price_discovery_analyzer(self) -> ComplianceService | None:
        try:
    ...
    def _create_call_auction(self) -> ComplianceService | None:
        try:
    ...
    def _create_var_calculator(self) -> ComplianceService | None:
        try:
    ...
    def _create_greeks_calculator(self) -> ComplianceService | None:
        try:
    ...
    def _create_stress_tester(self) -> ComplianceService | None:
        try:
    ...
    def _create_golden_signals(self) -> ComplianceService | None:
        try:
    ...
    def _create_trading_metrics(self) -> ComplianceService | None:
        try:
    ...
    def _create_toil_tracker(self) -> ComplianceService | None:
        try:
...
def get_service(service_name: str) -> ComplianceService | None:
    """
