...
class MarketDataService:
    ...
    def _initialize_default_feeds(self):
        ...
        yahoo_config = DataFeedConfig(
            ...
            rate_limit=100,
            supported_symbols=["AAPL", "MSFT", "GOOGL", "TSLA", "AMZN", "NVDA", "META", "NFLX"],
            supported_frequencies=[DataFrequency.REAL_TIME, DataFrequency.DAILY, DataFrequency.HOURLY],
    ...
    async def subscribe_to_symbols(self, symbols: List[str], feed_id: Optional[UUID] = None) -> bool:
    ...
    async def get_top_liquid_assets_quotes(self, limit: int = 20) -> List[Quote]:
        ...
        liquid_symbols = [
            ...
            "BRK.A", "JPM", "JNJ", "V", "PG", "UNH", "HD", "MA", "DIS", "PYPL", "ADBE", "CRM"
        ]
