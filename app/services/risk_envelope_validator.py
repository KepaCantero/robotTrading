...
class RiskEnvelopeValidator:
    ...
    def validate_trade(
        ...
        symbol_exposure_pct = new_symbol_exposure / total_capital if total_capital > 0 else Decimal("0")
        ...
        strategy_exposure_pct = new_strategy_exposure / strategy_capital if strategy_capital > 0 else Decimal("0")
        ...
        portfolio_exposure_pct = total_new_exposure / total_capital if total_capital > 0 else Decimal("0")
    ...
    def get_current_exposures(
        ...
        return {
            "portfolio_exposure_pct": float(total_portfolio_exposure / total_capital) if total_capital > 0 else 0.0,
            "strategy_exposure_pct": float(total_strategy_exposure / strategy_capital) if strategy_capital > 0 else 0.0,
