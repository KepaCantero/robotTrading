...
class ParameterOptimizationService:
    ...
    def __init__(self, cost_analysis_service: Optional[CostAnalysisService] = None):
        ...
        logger.info("ParameterOptimizationService initialized")
    ...
    async def optimize_parameters(
        ...
        try:
            ...
            if request.optimization_config.method == OptimizationMethod.WALK_FORWARD:
                ...
                raise ValueError(
                    f"Unsupported optimization method: {request.optimization_config.method}"
                )
    ...
    async def _optimize_period(
        ...
        return {"parameters": best_params, "score": score}
    ...
    async def _generate_purged_splits(
        ...
        for i in range(n_splits):
            ...
            if (
                ...
                and test_end <= end_date
                and train_end <= end_date
            ):
    ...
    async def perform_out_of_sample_test(
        self, request: OutOfSampleTestRequest
    ) -> OutOfSampleResult:
        """
    ...
    async def calculate_optimization_metrics(
        self, artifact: OptimizationArtifact
    ) -> OptimizationMetrics:
