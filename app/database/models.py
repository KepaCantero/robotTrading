...
class Asset(Base):
    ...
    asset_class: Mapped[str] = mapped_column(String(50), nullable=False)  # stock, etf, crypto, etc.
...
class Position(Base):
    ...
    realized_pnl: Mapped[Decimal] = mapped_column(Numeric(15, 2), default=Decimal('0'), nullable=False)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, nullable=False)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow, nullable=False)
...
class Trade(Base):
    ...
    commission: Mapped[Decimal] = mapped_column(Numeric(15, 4), default=Decimal('0'), nullable=False)
...
class RiskMetrics(Base):
    ...
    var_95: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 2), nullable=True)  # Value at Risk 95%
    var_99: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 2), nullable=True)  # Value at Risk 99%
    expected_shortfall: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 2), nullable=True)
    volatility: Mapped[Optional[Decimal]] = mapped_column(Numeric(8, 4), nullable=True)  # Annualized volatility
...
class SystemLog(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("level IN ('DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL')", name='ck_system_logs_level'),
    )
