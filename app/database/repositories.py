...
from app.database.models import (
    User, APIKey, Portfolio, Asset, Position, Trade, MarketData, 
    Signal, Backtest, RiskMetrics, SystemLog
)
...
class UserRepository(BaseRepository[User]):
    ...
    def get_by_username(self, username: str) -> Optional[User]:
        ...
        try:
            ...
            raise_database_error(
                f"Failed to get user by username: {str(e)}",
                "get_by_username",
                "users"
            )
    ...
    def get_active_users(self) -> List[User]:
        ...
        try:
            ...
            raise_database_error(
                f"Failed to get active users: {str(e)}",
                "get_active_users",
                "users"
            )
...
class PortfolioRepository(BaseRepository[Portfolio]):
    ...
    def update_total_value(self, portfolio_id: uuid.UUID, total_value: Decimal) -> bool:
        ...
        try:
            self.session.query(Portfolio).filter(
...
class AssetRepository(BaseRepository[Asset]):
    ...
    def get_by_symbol(self, symbol: str) -> Optional[Asset]:
        ...
        try:
            ...
            raise_database_error(
                f"Failed to get asset by symbol: {str(e)}",
                "get_by_symbol",
                "assets"
            )
    ...
    def get_active_assets(self) -> List[Asset]:
        ...
        try:
            ...
            raise_database_error(
                f"Failed to get active assets: {str(e)}",
                "get_active_assets",
                "assets"
            )
    ...
    def search_by_name(self, name_pattern: str) -> List[Asset]:
        ...
        try:
            return self.session.query(Asset).filter(
                Asset.name.ilike(f"%{name_pattern}%")
            ).all()
        except Exception as e:
            raise_database_error(
                f"Failed to search assets by name: {str(e)}",
                "search_by_name",
                "assets"
            )
...
class PositionRepository(BaseRepository[Position]):
    ...
    def get_by_portfolio_and_asset(self, portfolio_id: uuid.UUID, asset_id: uuid.UUID) -> Optional[Position]:
...
class TradeRepository(BaseRepository[Trade]):
    ...
    def get_by_asset(self, asset_id: uuid.UUID, limit: Optional[int] = None) -> List[Trade]:
        ...
        try:
            ...
            raise_database_error(
                f"Failed to get trades by asset: {str(e)}",
                "get_by_asset",
                "trades"
            )
    ...
    def get_trade_summary(self, portfolio_id: uuid.UUID) -> Dict[str, Any]:
        ...
        try:
            ...
            raise_database_error(
                f"Failed to get trade summary: {str(e)}",
                "get_trade_summary",
                "trades"
            )
...
class MarketDataRepository(BaseRepository[MarketData]):
    ...
    def get_by_asset_and_date_range(self, asset_id: uuid.UUID, start_date: datetime, end_date: datetime) -> List[MarketData]:
...
class SignalRepository(BaseRepository[Signal]):
    ...
    def get_by_asset(self, asset_id: uuid.UUID, limit: Optional[int] = None) -> List[Signal]:
        ...
        try:
            ...
            raise_database_error(
                f"Failed to get signals by asset: {str(e)}",
                "get_by_asset",
                "signals"
            )
...
class BacktestRepository(BaseRepository[Backtest]):
    ...
    def get_by_portfolio(self, portfolio_id: uuid.UUID) -> List[Backtest]:
        ...
        try:
            return self.session.query(Backtest).filter(
                Backtest.portfolio_id == portfolio_id
    ...
    def get_completed_backtests(self) -> List[Backtest]:
        ...
        try:
            ...
            ).order_by(Backtest.completed_at.desc()).all()
        except Exception as e:
            raise_database_error(
...
class RiskMetricsRepository(BaseRepository[RiskMetrics]):
    ...
    def get_latest_by_portfolio(self, portfolio_id: uuid.UUID) -> Optional[RiskMetrics]:
        ...
        try:
            ...
            ).order_by(RiskMetrics.calculation_date.desc()).first()
        except Exception as e:
            raise_database_error(
    ...
    def get_by_date_range(self, portfolio_id: uuid.UUID, start_date: datetime, end_date: datetime) -> List[RiskMetrics]:
        ...
        try:
            ...
            ).order_by(RiskMetrics.calculation_date.asc()).all()
        except Exception as e:
            raise_database_error(
...
class SystemLogRepository(BaseRepository[SystemLog]):
    ...
    def get_by_level(self, level: str, limit: Optional[int] = None) -> List[SystemLog]:
        ...
        try:
            ...
            raise_database_error(
                f"Failed to get logs by level: {str(e)}",
                "get_by_level",
                "system_logs"
            )
