# Validation Report: app/domain/services/backtesting/transaction_costs.py
**Generated:** 2026-02-07T05:21:30Z
...
## 4. Complexity (radon)
app/domain/services/backtesting/transaction_costs.py
    C 33:0 CostBreakdown - A (3)
    C 107:0 LinearCostModel - A (3)
    C 189:0 PiecewiseLinearCostModel - A (3)
    M 219:4 PiecewiseLinearCostModel._get_rate_for_quantity - A (3)
    M 45:4 CostBreakdown.cost_as_percentage - A (2)
    C 52:0 TransactionCostModel - A (2)
    M 137:4 LinearCostModel.calculate_cost - A (2)
    M 177:4 LinearCostModel.estimate_total_cost - A (2)
    M 226:4 PiecewiseLinearCostModel.calculate_cost - A (2)
    M 264:4 PiecewiseLinearCostModel.estimate_total_cost - A (2)
    C 276:0 MarketImpactModel - A (2)
    C 304:0 AlmgrenChristModel - A (2)
    M 343:4 AlmgrenChristModel.calculate_impact - A (2)
    C 410:0 SquareRootImpactModel - A (2)
    C 24:0 CostModelType - A (1)
    M 65:4 TransactionCostModel.calculate_cost - A (1)
    M 91:4 TransactionCostModel.estimate_total_cost - A (1)
    M 116:4 LinearCostModel.__init__ - A (1)
    M 201:4 PiecewiseLinearCostModel.__init__ - A (1)
    M 280:4 MarketImpactModel.calculate_impact - A (1)
    M 325:4 AlmgrenChristModel.__init__ - A (1)
    M 390:4 AlmgrenChristModel.calculate_permanent_impact - A (1)
    M 399:4 AlmgrenChristModel.calculate_temporary_impact - A (1)
    M 419:4 SquareRootImpactModel.__init__ - A (1)
    M 428:4 SquareRootImpactModel.calculate_impact - A (1)
    C 467:0 ImpactParameters - A (1)
    C 478:0 TemporaryImpact - A (1)
    C 486:0 PermanentImpact - A (1)

28 blocks (classes, functions, methods) analyzed.
Average complexity: A (1.6428571428571428)

## 5. Maintainability Index
app/domain/services/backtesting/transaction_costs.py - A (55.17)
...
---
## Summary
**Validation completed at:** 2026-02-07T05:21:30Z
