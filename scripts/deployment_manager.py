        ...
        try:
            ...
            for tg in tg_response['TargetGroups']:
                ...
                health_status[tg['TargetGroupName']] = {
                    ...
                    "healthy_count": len([t for t in health_response['TargetHealthDescriptions'] 
        ...
        try:
            ...
            for endpoint in endpoints:
                try:
                    ...
                    if response.status_code not in [200, 401, 403]:  # 401/403 are OK for protected endpoints
