...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler('logs/hyperparameter_optimization.log'), logging.StreamHandler()],
)
...
def main():
    ...
    results = optimizer.optimize(
        max_iterations=max_iterations, random_seed=42  # Para reproducibilidad
    )
