...
def check_storage_functionality():
    ...
    try:
        ...
        try:
            ...
            logger.info(f"✅ Storage funciona - {len(weights_list)} pesos encontrados para 'supervised'")
...
def check_configuration():
    ...
    try:
        ...
        checks = {
            ...
            "Incremental learning enabled": config.get('meta_analysis', {}).get('enable_incremental_learning', False),
