...
from app.core.config import Settings, get_settings, get_database_url, get_redis_url
...
class TestSettings:
    ...
    def test_database_url_methods(self):
        ...
        assert async_url == "postgresql+asyncpg://algotrading:algotrading@localhost:5432/algotrading"
