...
class TestExitConditionMonitor:
    ...
    @pytest.fixture
    def position_manager(self, default_symbol):
        """Create position manager."""
        pm = PositionManager()
        pm.update_position(default_symbol, Decimal("100"))
        return pm
    ...
    def test_check_exit_conditions_stop_loss_triggered(self, exit_monitor, sample_trades, default_symbol):
        ...
        assert close_called[0][0] == default_symbol
    ...
    def test_check_exit_conditions_no_trigger(self, exit_monitor, sample_trades, default_symbol):
        """Test no exit conditions triggered."""
        market_data = MockMarketData(default_symbol, close=150, low=145, high=155)
    ...
    def test_check_exit_conditions_no_position(self, exit_monitor, sample_trades, default_symbol):
    ...
    def test_check_exit_conditions_zero_position(self, exit_monitor, sample_trades, default_symbol):
        """Test exit check with zero position."""
        # Set position to zero
        exit_monitor.position_manager.close_position(default_symbol)
    ...
    def test_check_exit_conditions_no_open_trades(self, exit_monitor, default_symbol):
    ...
    def test_check_exit_conditions_uses_most_recent_trade(self, exit_monitor, default_symbol):
    ...
    def test_check_exit_conditions_no_stop_loss_config(self, default_symbol):
    ...
    def test_check_exit_conditions_no_take_profit_config(self, default_symbol):
        ...
        market_data = MockMarketData(default_symbol, close=170, low=145, high=181)
    ...
    def test_check_all_symbols_exit_conditions(self, exit_monitor, sample_trades, default_symbol):
