...
from app.models.assets import AssetRanking, AssetClass, Asset, Exchange
from app.models.momentum import TechnicalIndicators, MomentumStrategy, MomentumType, Timeframe
...
def asset_service_patch(mock_asset_service):
    ...
    with patch('app.services.asset_identification.get_asset_identification_service', return_value=mock_asset_service):
...
def momentum_service_patch(mock_momentum_service):
    ...
    with patch('app.services.momentum_analysis.get_momentum_analysis_service', return_value=mock_momentum_service):
