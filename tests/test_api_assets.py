...
from app.models.assets import Asset, AssetClass, Exchange, AssetUniverse, LiquidityMetrics, AssetRanking, AssetFilter
...
app.dependency_overrides[get_asset_identification_service] = override_get_asset_identification_service
...
class TestAssetAPI:
    ...
    def test_get_liquid_assets_success(self, client, mock_service, sample_asset_universe):
        ...
        # Mock service response - the API calls get_top_liquid_assets, not get_liquid_assets
    ...
    def test_filter_assets_success(self, client, mock_service, sample_asset):
        ...
        try:
            self._override_service(mock_service)
            response = client.post("/assets/filter", json={
                "asset_class": "equity",
