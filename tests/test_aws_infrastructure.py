...
class TestAWSInfrastructureConfig:
    ...
    def test_aws_config_structure(self):
        ...
        required_keys = [
            'region', 'environment', 'project_name', 'version',
            'vpc', 'ec2', 'rds', 'elasticache', 'security_groups', 'iam'
        ]
    ...
    def test_security_best_practices(self):
        ...
        assert elasticache.get('at_rest_encryption_enabled', False) or \
               elasticache.get('transit_encryption_enabled', False)
    ...
    def test_cost_optimization(self):
        ...
        elasticache = config['elasticache']
        assert elasticache.get('automatic_failover_enabled', True) == False  # Should be False for MVP
        ...
        for script_path in scripts:
            ...
            if script_file.exists():
                with open(script_file, 'r') as f:
                    ...
                    assert '#!/bin/bash' in content, f"Script {script_path} should have bash shebang"
