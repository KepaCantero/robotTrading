...
class TestLimitAdjuster:
    ...
    def test_detect_no_breaches(self):
        ...
        breaches = self.adjuster.detect_limit_breaches({"momentum": Decimal("30000")}, limits)
    ...
    def test_detect_warning_breach(self):
        ...
        breaches = self.adjuster.detect_limit_breaches({"momentum": Decimal("43000")}, limits)
    ...
    def test_detect_critical_breach(self):
        ...
        breaches = self.adjuster.detect_limit_breaches({"momentum": Decimal("55000")}, limits)
        assert len(breaches) == 1
    ...
    def test_validate_leverage_within_limits(self):
        ...
        is_valid, _ = self.adjuster.validate_leverage_within_limits(Decimal("1.5"), Decimal("2.0"))
        assert is_valid is True
