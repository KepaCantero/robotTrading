...
class TestCapitalCreation:
    ...
    def test_create_capital_with_negative_amount_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Capital amount must be positive"):
            Capital(amount=Decimal('-1000'), tier=CapitalTier.MICRO)

    def test_create_capital_with_zero_amount_raises_error(self):
        """Test that zero amount raises ValueError."""
        with pytest.raises(ValueError, match="Capital amount must be positive"):
            Capital(amount=Decimal('0'), tier=CapitalTier.MICRO)
    ...
    def test_create_capital_with_negative_leverage_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Max leverage must be positive"):
            Capital(amount=Decimal('10000'), tier=CapitalTier.SMALL, max_leverage=Decimal('-1'))

    def test_create_capital_with_zero_leverage_raises_error(self):
        """Test that zero leverage raises ValueError."""
        with pytest.raises(ValueError, match="Max leverage must be positive"):
            Capital(amount=Decimal('10000'), tier=CapitalTier.SMALL, max_leverage=Decimal('0'))
    ...
    def test_create_capital_with_negative_max_positions_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Max positions must be positive"):
            Capital(amount=Decimal('10000'), tier=CapitalTier.SMALL, max_positions=-5)

    def test_create_capital_with_zero_max_positions_raises_error(self):
        """Test that zero max_positions raises ValueError."""
        with pytest.raises(ValueError, match="Max positions must be positive"):
            Capital(amount=Decimal('10000'), tier=CapitalTier.SMALL, max_positions=0)
...
class TestCapitalImmutability:
    ...
    def test_capital_hash_is_consistent(self):
        ...
        capital1 = Capital(amount=Decimal('100000'), tier=CapitalTier.MEDIUM, currency='USD')
        capital2 = Capital(amount=Decimal('100000'), tier=CapitalTier.MEDIUM, currency='USD')
...
class TestCapitalMethods:
    ...
    def test_get_tier(self):
        ...
        capital = Capital(amount=Decimal('100000'), tier=CapitalTier.LARGE)
    ...
    def test_get_amount_returns_money(self):
        ...
        capital = Capital(amount=Decimal('100000'), tier=CapitalTier.MEDIUM, currency='USD')
    ...
    def test_get_max_exposure_without_leverage(self):
        ...
        capital = Capital(
            amount=Decimal('100000'), tier=CapitalTier.MEDIUM, max_leverage=Decimal('1')
        )
    ...
    def test_get_max_exposure_with_leverage(self):
        ...
        capital = Capital(
            amount=Decimal('100000'), tier=CapitalTier.MEDIUM, max_leverage=Decimal('2')
        )
    ...
    def test_get_max_exposure_with_fractional_leverage(self):
        ...
        capital = Capital(
            amount=Decimal('100000'), tier=CapitalTier.SMALL, max_leverage=Decimal('1.5')
        )
    ...
    def test_can_add_position_when_under_limit(self):
        ...
        capital = Capital(amount=Decimal('100000'), tier=CapitalTier.MEDIUM, max_positions=10)
    ...
    def test_is_strategy_enabled_with_empty_list(self):
        ...
        capital = Capital(amount=Decimal('100000'), tier=CapitalTier.MEDIUM, enabled_strategies=[])
...
class TestCapitalPropertyBased:
    ...
    def test_max_exposure_calculation(self, amount, leverage, expected):
        ...
        capital = Capital(amount=amount, tier=CapitalTier.MEDIUM, max_leverage=leverage)
    ...
    @pytest.mark.parametrize(
        "max_positions,current_positions,expected",
        [
            (5, 0, True),
            (5, 4, True),
            (5, 5, False),
    ...
    def test_can_add_position_various_scenarios(self, max_positions, current_positions, expected):
        ...
        capital = Capital(
            amount=Decimal('100000'), tier=CapitalTier.MEDIUM, max_positions=max_positions
        )
